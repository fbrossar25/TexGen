...
\begin{scope}[yscale=-1]
	...
	\node<1-3>[etat=noeudInactif] (A) at (-3.32,0.61){\scriptsize A};
	\node<4-16>[etat=noeudActif] (A) at (-3.32,0.61){\scriptsize A};
	\node<17-40>[etat=noeudParcourus] (A) at (-3.32,0.61){\scriptsize A};
	\node<1-40>[etat=noeudInactif] (G) at (-1.61,2.57){\scriptsize G};
	\node<1-40>[etat=noeudInactif] (I) at (-4.54,3.46){\scriptsize I};
	\node<1-40>[etatFinal=noeudInactif] (J) at (-3.65,3.47){\scriptsize J};
	\node<1-40>[etat=noeudInactif] (E) at (-3.91,2.55){\scriptsize E};
	\node<1-16>[etat=noeudInactif] (B) at (-4.43,1.57){\scriptsize B};
	\node<17-29>[etat=noeudActif] (B) at (-4.43,1.57){\scriptsize B};
	\node<30-40>[etat=noeudParcourus] (B) at (-4.43,1.57){\scriptsize B};
	\node<1-40>[etat=noeudInactif] (H) at (-5.1,3.43){\scriptsize H};
	\node<1-40>[etat=noeudInactif] (K) at (-2.75,3.49){\scriptsize K};
	\node<1-29>[etat=noeudInactif] (C) at (-2.16,1.6){\scriptsize C};
	\node<30-36>[etat=noeudActif] (C) at (-2.16,1.6){\scriptsize C};
	\node<37-40>[etat=noeudParcourus] (C) at (-2.16,1.6){\scriptsize C};
	\node<1-40>[etat=noeudInactif] (D) at (-5.02,2.52){\scriptsize D};
	\node<1-39>[etatFinal=noeudInactif] (F) at (-2.79,2.58){\scriptsize F};
	\node<40>[etatFinal=noeudSolution] (F) at (-2.79,2.58){\scriptsize F};

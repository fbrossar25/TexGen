...
\begin{scope}[yscale=-1]
	...
	\node<1-40>[etatFinal=noeudInactif] (J) at (-0.87,3.44){\scriptsize J};
	\node<1-40>[etat=noeudInactif] (G) at (1.12,2.6){\scriptsize G};
	\node<1-40>[etat=noeudInactif] (D) at (-2.29,2.55){\scriptsize D};
	\node<1-40>[etat=noeudInactif] (H) at (-2.37,3.46){\scriptsize H};
	\node<1-40>[etat=noeudInactif] (E) at (-1.21,2.54){\scriptsize E};
	\node<1-40>[etat=noeudInactif] (K) at (-0.08,3.47){\scriptsize K};
	\node<1-3>[etatInit] (A) at (-0.66,0.64){\scriptsize A};
	\node<4-16>[etatInit=noeudActif] (A) at (-0.66,0.64){\scriptsize A};
	\node<17-40>[etatInit] (A) at (-0.66,0.64){\scriptsize A};
	\node<1-29>[etat=noeudInactif] (C) at (0.57,1.63){\scriptsize C};
	\node<30-36>[etat=noeudActif] (C) at (0.57,1.63){\scriptsize C};
	\node<37-40>[etat=noeudParcourus] (C) at (0.57,1.63){\scriptsize C};
	\node<1-16>[etat=noeudInactif] (B) at (-1.7,1.6){\scriptsize B};
	\node<17-29>[etat=noeudActif] (B) at (-1.7,1.6){\scriptsize B};
	\node<30-40>[etat=noeudParcourus] (B) at (-1.7,1.6){\scriptsize B};
	\node<1-40>[etat=noeudInactif] (I) at (-1.69,3.46){\scriptsize I};
	\node<1-39>[etatFinal=noeudInactif] (F) at (-0.13,2.61){\scriptsize F};
	\node<40>[etatFinal=noeudSolution] (F) at (-0.13,2.61){\scriptsize F};

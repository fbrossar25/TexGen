...
\begin{scope}[yscale=-1]
	...
	\node<1-40>[etat=noeudInactif] (D) at (-1.72,3.43){\scriptsize D};
	\node<1-29>[etat=noeudInactif] (C) at (1.14,2.51){\scriptsize C};
	\node<30-36>[etat=noeudActif] (C) at (1.14,2.51){\scriptsize C};
	\node<37-40>[etat=noeudParcourus] (C) at (1.14,2.51){\scriptsize C};
	\node<1-40>[etat=noeudInactif] (H) at (-1.8,4.34){\scriptsize H};
	\node<1-3>[etat=noeudInactif] (A) at (-0.02,1.52){\scriptsize A};
	\node<4-16>[etat=noeudActif] (A) at (-0.02,1.52){\scriptsize A};
	\node<17-40>[etat=noeudParcourus] (A) at (-0.02,1.52){\scriptsize A};
	\node<1-40>[etat=noeudInactif] (G) at (1.69,3.48){\scriptsize G};
	\node<1-40>[etat=noeudInactif] (K) at (0.55,4.4){\scriptsize K};
	\node<1-39>[etatFinal=noeudInactif] (F) at (0.51,3.49){\scriptsize F};
	\node<40>[etatFinal=noeudSolution] (F) at (0.51,3.49){\scriptsize F};
	\node<1-40>[etatFinal=noeudInactif] (J) at (-0.35,4.38){\scriptsize J};
	\node<1-16>[etat=noeudInactif] (B) at (-1.13,2.48){\scriptsize B};
	\node<17-29>[etat=noeudActif] (B) at (-1.13,2.48){\scriptsize B};
	\node<30-40>[etat=noeudParcourus] (B) at (-1.13,2.48){\scriptsize B};
	\node<1-40>[etat=noeudInactif] (I) at (-1.24,4.37){\scriptsize I};
	\node<1-40>[etat=noeudInactif] (E) at (-0.61,3.46){\scriptsize E};

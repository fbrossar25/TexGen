...
\definecolor{noeudActif}{RGB}{204,0,204}
...
\begin{scope}[yscale=-1]
	...
	\node<1-16>[etat=noeudInactif] (B) at (-1.19,2.38){\scriptsize B};
	\node<17-29>[etat=noeudActif] (B) at (-1.19,2.38){\scriptsize B};
	\node<30-40>[etat=noeudParcourus] (B) at (-1.19,2.38){\scriptsize B};
	\node<1-3>[etat=noeudInactif] (A) at (-0.07,1.42){\scriptsize A};
	\node<4-16>[etat=noeudActif] (A) at (-0.07,1.42){\scriptsize A};
	\node<17-40>[etat=noeudParcourus] (A) at (-0.07,1.42){\scriptsize A};
	\node<1-40>[etat=noeudInactif] (D) at (-1.78,3.33){\scriptsize D};
	\node<1-40>[etat=noeudInactif] (H) at (-1.86,4.24){\scriptsize H};
	\node<1-39>[etatFinal=noeudInactif] (F) at (0.46,3.39){\scriptsize F};
	\node<40>[etatFinal=noeudSolution] (F) at (0.46,3.39){\scriptsize F};
	\node<1-29>[etat=noeudInactif] (C) at (1.08,2.41){\scriptsize C};
	\node<30-36>[etat=noeudActif] (C) at (1.08,2.41){\scriptsize C};
	\node<37-40>[etat=noeudParcourus] (C) at (1.08,2.41){\scriptsize C};
	\node<1-40>[etatFinal=noeudInactif] (J) at (-0.4,4.28){\scriptsize J};
	\node<1-40>[etat=noeudInactif] (G) at (1.63,3.38){\scriptsize G};
	\node<1-40>[etat=noeudInactif] (I) at (-1.27,4.27){\scriptsize I};
	\node<1-40>[etat=noeudInactif] (K) at (0.49,4.3){\scriptsize K};
	\node<1-40>[etat=noeudInactif] (E) at (-0.67,3.36){\scriptsize E};
	...
	\draw<1-30>[lien=lienInactif] (C) -> (F) node[midway, above] {\scriptsize 2};
	\draw<31-32>[lien=lienActif] (C) -> (F) node[midway, above] {\scriptsize 2};
	\draw<33-39>[lien=lienParcourus] (C) -> (F) node[midway, above] {\scriptsize 2};
	\draw<40>[lien=lienSolution] (C) -> (F) node[midway, above] {\scriptsize 2};
	...
	\draw<1-8>[lien=lienInactif] (A) -> (C) node[midway, above] {\scriptsize 1};
	\draw<9-12>[lien=lienActif] (A) -> (C) node[midway, above] {\scriptsize 1};
	\draw<13-39>[lien=lienParcourus] (A) -> (C) node[midway, above] {\scriptsize 1};
	\draw<40>[lien=lienSolution] (A) -> (C) node[midway, above] {\scriptsize 1};
\end{scope}
\end{tikzpicture}
\end{center}
\end{frame}
